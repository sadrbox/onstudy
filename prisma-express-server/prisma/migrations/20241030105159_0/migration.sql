/*
  ...
  - You are about to alter the column `bin` on the `Counterparties` table. The data in that column could be lost. The data in that column will be cast from `BigInt` to `Int`.
