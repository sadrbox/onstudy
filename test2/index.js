...
// const comConnectorPath = "V83COMConnector";
var con = new winax.Object("V83.COMConnector");

// Создание экземпляра COM-объекта
// const comConnector = winax.Variant(comConnectorPath);
const connectString =
	"Srvr=192.168.1.111;Ref=templatedb;Usr=support;Pwd=MasterPass123;";

// Вызов методов COM-объекта
const access = con.Connect(connectString);
// console.log(access);
const products = access.Catalogs.Номенклатура.Select();
console.log(products);
// const newProducts = products.Select();
